...
// DummyChat.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CDummyChatApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CDummyChatApp

CDummyChatApp::CDummyChatApp()
{
...
// El único objeto CDummyChatApp

CDummyChatApp theApp;


// Inicialización de CDummyChatApp

BOOL CDummyChatApp::InitInstance()
{
